...
4. **Auditoría de aislamiento en curso (7 jul):** no dar por definitivo el aislamiento verificado el 6 jul. Handoff de verificación al Agente n8n: `docs/2026-07-07-handoff-agente-n8n-verificacion-aislamiento-staging.md` — incluye regenerar el `webhookId` heredado de prod en el trigger importado (tarea que **no depende** de la Meta App, se puede ejecutar ya).
