...
6. **Siguiente paso:** reintentar el "hola" por WhatsApp para continuar la validación E2E del Bug #10 (serie inválida → re-pregunta 2-3×; serie válida → procede a Quálitas sandbox).
