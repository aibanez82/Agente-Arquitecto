...
**Seguimiento automático de leads estancados (15-19 jul):** 7 checkpoints, hasta 3 reintentos. ✅ **Desplegado a PROD** en arranque seguro (`ENABLED=false`, dry-run activo) — falta pasar a envío real. Detalle: `docs/iniciativas/seguimiento-leads-estancados.md`.
