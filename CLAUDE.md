...
- **Una retractación solo existe si se escribe en el mismo canal que el error:** corregirse en conversación o en memoria no alcanza a quien ya está actuando sobre el fichero publicado. Mientras el original siga en pie sin marca, sigue siendo la verdad operativa. Marcar el original y publicar la corrección **en su canal**, el mismo día.
