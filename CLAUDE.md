...
| Promoción a PROD del copy M47/M48 (activación diferida) en n8n | ⏳ Bloqueante Django resuelto (`HYL-WAI#114` cerrado el 24 jul). **Sin issue que trackee la promoción, y el estado en n8n PROD sin verificar** (19 ago). Defecto adjunto vivo: `qualitas-issues#66` — guard de los 30 días de diferimiento, que NO es este pendiente |
