...
| Exponer `fecha_inicio` en emisión de póliza — Issue #114 `aguayo-co/HYL-WAI` | ✅ **En PROD desde 27 jul** (PR #125 stg→main, release Heroku v331 = `43bfaf2`, migraciones `qualitas 0047–0052` verificadas en vivo). Máx. 30 días de diferimiento (límite real Quálitas). Falta solo el lado n8n: promoción selectiva renovación + `Issue Policy` — handoff `Agente-n8n/handoffs/2026-07-27-handoff-promocion-selectiva-renovacion-fecha-inicio-prod.md`. Desbloquea M47/M48 |
