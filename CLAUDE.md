...
- **Tablero vivo del rollout (decisión Alberto 4 ago):** al cerrar CADA tarea material, actualizar el artifact "Dual Rollout — STG" (`https://claude.ai/code/artifact/737115a2-251b-476a-98f1-613f9e2d6002`) con la herramienta Artifact pasando esa URL como `url` (sin ella se crea una URL nueva — error). Mantener su estructura (métricas, estado de ejecución, etapas), favicon 🚦 y sello de fecha/hora CDMX.
