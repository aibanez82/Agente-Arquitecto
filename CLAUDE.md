...
**Seguimiento automático de leads estancados (15-17 jul):** 7 checkpoints derivados en vivo, hasta 3 reintentos. Configurado y activado en STG; primer envío real falló con 403 (credencial sin prefijo `Bearer`), corregido y verificado 17 jul. **Pendiente: primera prueba end-to-end real todavía sin confirmar.** (Descartado: el scheduler de 15 min real es de 4 min y solo aplica si el cliente no respondió nada — sin solapamiento.) Detalle: `docs/iniciativas/seguimiento-leads-estancados.md`.
