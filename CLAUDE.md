...
- **Un handoff que deroga a otro lo dice dentro de sí mismo, y marca el derogado:** si la instrucción que se anula puede estar ya en ejecución, el handoff nuevo la **nombra** (fichero y §) y el original se **marca en su propio fichero, el mismo día**. Publicar la derogación aparte no basta: **un ejecutor que ya arrancó no vuelve a mirar `main`**, así que cumple lo que leyó — y acaba ejecutando lo derogado por obedecer bien.
